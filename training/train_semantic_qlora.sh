...
OUTPUT_DIR="${OUTPUT_DIR:-output/semantic_qwen3_8b_qlora_seed_${SEED:-42}}"
...
python training/write_run_manifest.py semantic "$OUTPUT_DIR" "$MODEL" "$TRAIN_JSONL" "$VAL_JSONL" --seed "$SEED"
